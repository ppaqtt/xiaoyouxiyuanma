...
欢迎来到 Python 小游戏合集！这里包含了 **204个** 精美的 Python 小游戏，涵盖了22个分类和各种类型难度。

## 📁 文件说明

### 启动器
- **game_launcher.py** - 游戏启动器 v1.0（标准版）
- **game_launcher_v2.py** - 游戏启动器 v2.0（改进版，推荐使用）
...
### 2. 使用游戏启动器（推荐）
```bash
python game_launcher_v2.py
```

### 3. 直接运行游戏
```bash
python simple_stardew_valley.py     # 简易星露谷
python multiplayer_bomberman.py     # 多人炸弹人
python life_simulator.py           # 生命模拟器
```
...
| **简易星露谷** ✨ | simple_stardew_valley.py | **像素农场** |
...
| **吉他英雄** ✨ | guitar_hero.py | **节奏按键** |
| **像素艺术编辑器** ✨ | pixel_art_editor.py | **自由绘画** |
...
| **多人炸弹人** ✨ | multiplayer_bomberman.py | **2-4人对战** |
...
| **农场大亨** ✨ | idle_farm.py | **多作物种植** |
| **生产线帝国** ✨ | idle_factory.py | **工厂管理** |
| **梦想城市** ✨ | idle_city.py | **城市规划** |
| **挖矿大亨** ✨ | idle_mining.py | **矿石采集** |
| **英雄传奇** ✨ | idle_heroes.py | **英雄培养** |
...
| **方程式赛车** ✨ | formula_racing.py | **氮气加速** |
| **漂移大师** ✨ | drift_racing.py | **甩尾漂移** |
...
| **命运抉择** ✨ | text_adventure_story.py | **分支冒险** |
| **神秘逃脱** ✨ | escape_mystery.py | **多房间谜题** |
| **侦探事务所** ✨ | detective_story.py | **线索推理** |
...
| **化学元素猜猜乐** ✨ | chemistry_elements.py | **元素分类** |
| **太空探索** ✨ | space_astronomy.py | **行星收集** |
| **环球冒险知识问答** ✨ | geography_trivia.py | **大洲主题** |
| **数学大冒险** ✨ | math_puzzle.py | **RPG数学** |
| **细胞工厂** ✨ | biology_cells.py | **模拟经营** |
| **时间旅行大冒险** ✨ | history_trivia.py | **时代探索** |
...
| **滑雪大冒险** ✨ | skiing_game.py | **躲避障碍** |
| **街头滑板** ✨ | skateboard_game.py | **技巧动作** |
...
| **街头篮球** ✨ | basketball_game.py | **投篮技巧** |
| **热血足球** ✨ | soccer_game.py | **足球对战** |
| **高尔夫精英** ✨ | golf_game.py | **高尔夫球** |

### 19. 🎭 角色扮演（4个）
| 游戏 | 文件 | 说明 |
|------|------|------|
| **生命模拟器** ✨ | life_simulator.py | **从出生到死亡** |
| **宠物养成** ✨ | pet_simulator.py | **喂食/玩耍/洗澡** |
| **太空殖民地** ✨ | space_colony.py | **资源/建筑管理** |
| **海盗冒险** ✨ | pirate_adventure.py | **海上探险** |

### 20. 🥊 格斗竞技（2个）🆕新增
| 游戏 | 文件 | 说明 |
|------|------|------|
| **街头格斗** ✨ | street_fighter.py | **2D对战** |
| **拳击冠军** ✨ | boxing_game.py | **拳击比赛** |
...
| 游戏 | 文件 | 类型 | 特色 |
|------|------|------|------|
| 滑雪大冒险 | skiing_game.py | 滑雪 | 躲避树木和岩石、距离计分、粒子特效 |
| 街头滑板 | skateboard_game.py | 滑板 | Ollie/Kickflip/Heelflip技巧、连击加分 |

#### 体育竞技类游戏（3个）
| 游戏 | 文件 | 类型 | 特色 |
|------|------|------|------|
| 街头篮球 | basketball_game.py | 篮球 | 蓄力瞄准、角度调节、命中率统计 |
| 热血足球 | soccer_game.py | 足球 | 踢球力度、AI对手、进球判定 |
| 高尔夫精英 | golf_game.py | 高尔夫 | 风向影响、9洞挑战、水障碍 |

#### 角色扮演类游戏（1个）
| 游戏 | 文件 | 类型 | 特色 |
|------|------|------|------|
| 海盗冒险 | pirate_adventure.py | 冒险RPG | 海上探险、武器升级、敌人战斗 |

#### 格斗竞技类游戏（2个）
| 游戏 | 文件 | 类型 | 特色 |
|------|------|------|------|
| 街头格斗 | street_fighter.py | 格斗 | 2D对战、特殊技能、格挡跳跃 |
| 拳击冠军 | boxing_game.py | 拳击 | 直拳/勾拳/上勾拳、回合制、能量管理 |
...
### ✨ 独特玩法
所有游戏都有独立的游戏体验和逻辑，无重复的"换皮"游戏：

#### 竞速运动类
- 🏂 滑雪大冒险：躲避障碍、距离计分、粒子特效
- 🛹 街头滑板：Ollie/Kickflip/Heelflip技巧、连击加分

#### 体育竞技类
- 🏀 街头篮球：蓄力瞄准、角度调节、命中率统计
- ⚽ 热血足球：踢球力度、AI对手、进球判定
- 🏌️ 高尔夫精英：风向影响、9洞挑战、水障碍

#### 角色扮演类
- 🏴‍☠️ 海盗冒险：海上探险、武器升级、敌人战斗

#### 格斗竞技类
- 👊 街头格斗：2D对战、特殊技能、格挡跳跃
- 🥊 拳击冠军：直拳/勾拳/上勾拳、回合制、能量管理
...
### 音效系统
所有游戏内置音效系统，使用bytearray生成，无需外部音频文件。
